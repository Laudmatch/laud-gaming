	...
	<html>
		...
		<body>
			<header>
				...
				<div class = "menu">
					<ul class = "b_menu">
						...
						<li class = "menu_element">
							<a href = "/novinki" class = "menu_element_txt_now">
								<b>НОВИНКИ</b>
							</a>
						</li>
						<li class = "menu_element">
			...
			<div class = "content">
				...
				<div class = "game">
				<a href = "/t18" class = "ss1">
					<div class = "img">
						<img src = "img/game51.png">
					</div>
					<div class = "game_txt">
						<div class = "nazv">
				...
				<div class = "game">
				<a href = "/t19" class = "ss1">
					<div class = "img">
						<img src = "img/game52.png">
					</div>
					<div class = "game_txt">
						<div class = "nazv">
				...
				<div class = "game">
				<a href = "/t20" class = "ss1">
					<div class = "img">
						<img src = "img/game53.png">
					</div>
					<div class = "game_txt">
						<div class = "nazv">
